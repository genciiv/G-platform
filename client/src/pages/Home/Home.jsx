        ...
        try {
          if (
            ...
            if (!fallbackSecs.length) {
              setErr(
                "S’ka seksione. Aktivizo “Show on Home” te Admin → Kategori."
              );
            }
          } else {
                ...
                {sec.items.map((p) => {
                  ...
                  return (
                    <div className="p-card" key={p._id}>
                      {/* ✅ MOS e bëj button brenda button */}
                      <div
                        className="p-mediaWrap"
                      ...
                      >
                        ...
                        {/* ✅ Zemra toggle (jashtë p-media button) */}
                        <button
                          type="button"
                          onClick={() => toggleFav(p)}
                          title="Favourite"
